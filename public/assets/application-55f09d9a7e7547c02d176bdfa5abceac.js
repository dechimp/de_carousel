...
(function() {
  $(function() {
    var $carousel, $carouselLeftBtn, $carouselRightBtn, $carouselcontainer, autoAdvanceDelay, autoAdvanceEnabled, autoAdvanceInterval, carouselDots, carouselEnabled, carouselIndex, carouselScreenCount, carousel_slides, changeDotAppearance, emerge, flippers, get_upcoming_slide_text, moveCarousel, reset_emerge_for_inactive_slides, slideBack, slideForward, slideTo, startAutoAdvance, textEmergeDelay;
    ...
    /* Carousel */
    get_upcoming_slide_text = function() {
      var slide_text, upcoming_slide;
      upcoming_slide = carousel_slides.get(carouselIndex);
      slide_text = $(upcoming_slide).children().first();
      return slide_text;
    };
    reset_emerge_for_inactive_slides = function() {
      var slide_text_elements;
    ...
    changeDotAppearance = function(selectedDotElement) {
    ...
    startAutoAdvance = function() {
      if (carouselEnabled && autoAdvanceEnabled) {
    ...
    carouselDots.click(function(e) {
      var clickedDot, newIndex;
      e.preventDefault();
      clickedDot = $(this);
    ...
    $carouselcontainer.on('click', '.flipper', function() {
      clearInterval(autoAdvanceInterval);
      startAutoAdvance();
    });
    $carouselcontainer.on('click', '.rightbutton', function() {
      slideForward();
    });
    $carouselcontainer.on('click', '.leftbutton', function() {
      slideBack();
    });
    ...
    /* flippers */
    if (carouselEnabled) {
      return flippers.on('mouseover', function() {
        flippers.removeClass('hidden');
